...
from transformer import Time2Vector, SingleAttention, MultiAttention, TransformerEncoder
...
ax11.plot(pd.DataFrame(y), label='RSI')
ax11.plot(pd.DataFrame(train_pred), linewidth=3, label='Predicted RSI')
ax11.set_ylabel('RSI')
